"""
Runs the teacher pipeline (14B) on Faiza's task subset and logs full trajectories.
...
INPUT_FILE = "datasets/raw/tasks_faiza_14b.json"
OUTPUT_FILE = "datasets/raw/trajectories_faiza_14b.json"
