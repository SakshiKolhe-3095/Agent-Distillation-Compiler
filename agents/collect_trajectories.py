"""
Runs the teacher pipeline on a task subset and logs full trajectories.
...
INPUT_FILE = "datasets/raw/tasks_yeshita_7b.json"
OUTPUT_FILE = "datasets/raw/trajectories_yeshita_7b.json"
